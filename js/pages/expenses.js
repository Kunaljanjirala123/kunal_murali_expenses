...
import { formatUSD, formatDate, today, showToast, openModal, closeModal, EXPENSE_CATEGORIES, getCategoryColor, staggerChildren, confirmAction } from '../utils.js';
...
export function initExpenses() {
  ...
  document.querySelectorAll('.delete-expense').forEach(btn => {
    btn.addEventListener('click', () => {
      confirmAction('Delete Expense', 'Are you sure you want to delete this expense?', () => {
